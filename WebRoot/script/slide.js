...
var PImgPlayer = {   
        ...
        init : function( objID, w, h, time ){   
                ...
                //   
                var ulStyle = "margin:0 0 29px 0;width:"+w+"px;position:absolute;z-index:999;right:0px;FILTER:Alpha(Opacity=30,FinishOpacity=30, Style=1);overflow: hidden;bottom:-1px;height:16px; border-right:1px solid skyblue;";  
                var ulStyle2 = "margin:0;padding:5px 5px 0 5px;width:"+w+"px;position:absolute;;overflow: hidden;bottom:-1px;height:24px; border-right:1px solid #fff;font-size:14px;font-weight:bold;text-align:center;background:skyblue;FILTER:Alpha(Opacity=30,FinishOpacity=30, Style=1);"; 
                //   
                var liStyle = "margin:0;list-style-type: none; margin:0;padding:0; float:right;";   
                //   
                var baseSpacStyle = "clear:both; display:block; width:23px;line-height:18px; font-size:12px; FONT-FAMILY:verdana, Arial, Helvetica, sans-serif;opacity: 0.6;";   
