...
<html>
  ...
  <div><hr color="#8B785F"></div>
   <div class="p_left">
    <form action="checkinHistory?page=${currentPage}" method="post">
    	<table>
    		<tbody>
	    		<tr>
	  				<td><b>行号</b></td>
    		...
    		<tbody>
    		<s:iterator status="indexsno" value="inlist">
        ...
        <td colspan="10">
            ...
            <s:if test="%{currentPage != 1&& total!=0}">
	           	<a href="checkinHistory?page=1">首页</a>
	            <a href="checkinHistory?page="+${currentPage-1}>上一页</a>
         	</s:if>
            <s:if test="%{currentPage != totalPage&& total!=0}">
	         	<a href="checkinHistory?page=<s:property value="%{currentPage+1}"/>">下一页</a>
	        	<a href="checkinHistory?page=<s:property value="totalPage"/>">尾页</a>
            </s:if>
        </td>
        </tr>
        </tbody>
